        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse mx-auto" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-primary" href="DeleteTableOptions.php">Delete From Database</a>
                    </li>
                    <li class="nav-item">
    ...
    <Section>
        <div class="container text-center mt-3">
            <ul class="list border border-primary">
                <li>
                    <a class="btn btn-primary mt-5" href="CountryRecords.php">Country Table</a>
                </li>
                <li>
                    <a class="btn btn-primary mt-5" href="DirectorRecords.php">Director Table</a>
                </li>
                <li>
                    <a class="btn btn-primary mt-5" href="MovieRecord.php">Movie Table</a>
                </li>
                <li>
                    <a class="btn btn-primary mt-5" href="MovieCastRecords.php">Moviecast Table</a>
                </li>
                <li>
                    <a class="btn btn-primary my-5" href="MovieGenreRecords.php">Movie Genre Table</a>
                </li>
