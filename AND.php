...
<head>
  ...
  <title>Moviebuzz - AND</title>
</head>
<body style="background: #212529; color:white;">

  <h2 align="center">Showing movies records of IMDB Rating 9 and Year 2019</h2>
...
$records = mysqli_query($db,"SELECT * FROM movie WHERE IMDBrating = 9 AND year = 2019"); // fetch data from database
