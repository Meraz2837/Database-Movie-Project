          ...
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item active text-danger" href="AboutDeveloper.php">About Developer</a></li>
              </ul>
            </li>
  ...
  <section class="container-fluid mt-5">
    ...
    <div class="card my-3 mx-auto bg-dark border-danger" style="max-width: 1800px;">
      <div class="row g-0 m-5">
        <div class="col-md-8 my-auto">
          <div class="card-body text-white">
            <h2 class="card-title text-danger">Daffodil International University<br>Department of CSE</h2>
            <p>Semester: Seventh</p>
            <p>CGPA: 3.96</p>
            <p>Section: PC-A</p>
          </div>
        </div>
        <div class="col-md-4 bg-dark">
          <img src="Icons/diuIcon.png" class="img-fluid rounded-start" alt="Diu">
        </div>
      </div>
    </div>
  </section>
