...
<body style="background: #212529; color:white;">
  ...
  <h2 align="center">Movie Details of both Muicize and Foster</h2>
...
$records = mysqli_query($db,"SELECT * FROM movie WHERE title = 'Muicize' OR title = 'Foster'"); // fetch data from database
